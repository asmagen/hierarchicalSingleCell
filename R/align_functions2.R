...
align2 <- function(T1, T2, cost_matrix) {
  ...
  align_obj <- initialize2(align_obj)
...
#' @export
initialize2 <- function(align_object) {
  align_object$T1_children <- create_children_map2(align_object$T1)
  align_object$T2_children <- create_children_map2(align_object$T2)
