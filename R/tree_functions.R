...
paste_collapse <- function(...) paste0(..., collapse = '_')
...
fill_F_helper <- function(align_obj, i, s, p, j, t, q) {
  choix_1 <- align_obj$F_map[[i, 1, s]]
  align_obj$F_map[[paste_collapse(1, i, s, p, 2, j, t, q)]] <- min(res)
  return(align_obj)
}